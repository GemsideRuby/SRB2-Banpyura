...
static void D_Display(void)
{
	...
	if (paused && cv_showhud.value && (!menuactive || netgame))
	{
		...
		V_DrawCenteredString(BASEVIDWIDTH/2, y - (4), MENUCOLOR, "Game Paused");
#endif
	}
	...
	if (!wipe)
	{
		if (cv_netstat.value)
		{
			...
			V_DrawRightAlignedString(BASEVIDWIDTH, BASEVIDHEIGHT-40, MENUCOLOR, s);
			snprintf(s, sizeof s - 1, "send %d b/s", sendbps);
			V_DrawRightAlignedString(BASEVIDWIDTH, BASEVIDHEIGHT-30, MENUCOLOR, s);
			snprintf(s, sizeof s - 1, "GameMiss %.2f%%", gamelostpercent);
			V_DrawRightAlignedString(BASEVIDWIDTH, BASEVIDHEIGHT-20, MENUCOLOR, s);
			snprintf(s, sizeof s - 1, "SysMiss %.2f%%", lostpercent);
			V_DrawRightAlignedString(BASEVIDWIDTH, BASEVIDHEIGHT-10, MENUCOLOR, s);
		}
